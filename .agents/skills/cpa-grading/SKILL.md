---
name: cpa-grading
description: Grading prompt template, 10-item feedback schema, scoring math, and Zod validation for the grader's Codex response. Use for Task 7 and any code that consumes Feedback rows.
---

# CPA Grading

One Codex Sonnet 4.6 call per question. Inputs: extracted question payload + user's transcript. Outputs: 10 structured feedback items + 3 scores.
...
- Do not call OpenAI. Codex Sonnet 4.6 only.
