...
const FUNCTION_LABELS: Record<string, string> = {
  ...
  CHECKPOINT_QUIZ: 'Legacy Checkpoint Quiz',
...
const FUNCTION_META: Record<string, { description: string; interest: string; downtime: string }> = {
  ...
  CHECKPOINT_QUIZ: { description: 'Reserved for manual checkpoint endpoints; Study uses indexed Anki cards.', interest: 'Low', downtime: 'Live' },
